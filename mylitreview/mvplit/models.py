...
class Review(models.Model):
    ticket = models.ForeignKey(Ticket, default='', on_delete=models.CASCADE, 
...
class CriticAutoReview(models.Model):
    auto_review = models.ForeignKey(AutoReview, on_delete=models.CASCADE, 
                                    related_name='critic_auto_reviews')
    rating = models.PositiveSmallIntegerField(choices=CHOICES)
    user = models.ForeignKey(User, on_delete=models.CASCADE, 
                            related_name='critic_auto_reviews')
    headline = models.CharField(max_length=128)
...
class Follow(models.Model):
    ...
    value = models.CharField(choices=FOLLOW_CHOICES, 
                            default='Follow', 
                            max_length=15)
